...
const Mission = () => {
    return (
        <section id="services" className="p-8 border-b-2 bg-gray-100">
            <h2 className="text-3xl font-bold mb-6 text-center"> Stargardt Disease Affected Children</h2>
            <div className="flex flex-wrap justify-center">
                <div className="bg-white shadow-lg p-6 rounded-lg mb-6 w-80 ms-2 ">
                ...
                <div className="bg-white shadow-lg p-6 rounded-lg mb-6 w-80 ms-4">
